...
export function HeroSection() {
  ...
  return (
    ...
    >
      <motion.div ref={badgeref} style={{ opacity: 0, y: badgeY }} className="flex items-center gap-2 mb-6">
      ...
      <motion.h1 style={{ y: titleY }} className="font-display font-bold text-4xl md:text-6xl lg:text-[72px] leading-[1.1] tracking-[-0.04em] text-white mb-6">
      ...
      <motion.div style={{ y: subtitleY }} className="flex flex-col items-center gap-2">
